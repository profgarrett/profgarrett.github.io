...
This is a short guide on how to setup custom AI Chatbots for a college class. This provides instructions for setting up and using the Tutorbot, as well as some problems that you may run into during the process.
...
is outside of scope, indicate that you are unable to help and refer the student to the professor for
assistance.
